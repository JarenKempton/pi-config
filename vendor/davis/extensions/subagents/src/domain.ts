...
export type SubagentOrigin = "model" | "btw" | "wayfinder";
...
export interface SpawnTask {
   ...
   * codex/cursor: model slug. Omitted = backend default / inherit.
   */
  readonly model?: string;
  /** Shared effort scale; each backend maps it to its native equivalent. */
  readonly reasoningEffort?: ReasoningEffort;
  /** Safety/permission profile. Omitted = scout. */
...
export interface SubagentMeta {
  ...
  /** Claude/Cursor session id / Codex conversation id. */
...
export type SubagentEvent =
  ...
  | {
      ...
      readonly contextWindow?: number;
      /** Cumulative API-equivalent cost for this child session. */
      readonly costUsd?: number;
      /** False when the backend cannot price the observed usage yet. */
