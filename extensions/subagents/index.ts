...
// This pi-config package is the source of truth, so resolve sibling extensions
// from the package checkout instead of ~/.pi/agent/extensions.
const EXT_BASE = path.resolve(EXT_DIR, "..");
